...
//////////////////////////
    ...
    /*Fuerzas Armadas Tropicales, a weak armed force from a caribbean nation
    based in outdated eastern equipment complemented with western patches
    uses mostly olive camo and URSS based uniforms*/
...
["flagTexture", QPATHTOFOLDER(Pictures\Flags\FAN.paa)] call _fnc_saveToTemplate;
["flagMarkerType", "FAN_flag"] call _fnc_saveToTemplate;
