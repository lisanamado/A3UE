...
//////////////////////////
    ...
    /*Fuerzas Armadas Nacionales, a weak armed force from a caribbean nation
    based in outdated western equipment complemented with eastern patches
    uses mostly AAF digital camo and US based uniforms*/

#include "..\..\script_component.hpp"

["name", "FAT"] call _fnc_saveToTemplate;
["spawnMarkerName", "FAT Support Corridor"] call _fnc_saveToTemplate;

["flag", "Flag_NATO_F"] call _fnc_saveToTemplate;
["flagTexture", QPATHTOFOLDER(Pictures\Flags\FAT.paa)] call _fnc_saveToTemplate;
["flagMarkerType", "FAT_flag"] call _fnc_saveToTemplate;
...
["vehiclesBasic", ["I_Quadbike_01_F"]] call _fnc_saveToTemplate;			 // unarmed or armed, with 0-2 passengers
