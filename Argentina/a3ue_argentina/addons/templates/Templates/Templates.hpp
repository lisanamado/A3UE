class Templates 
{
    ...
    class Fuerzas_Armadas_Argentinas : Vanilla_Base
    {
        ...
        name = "Fuerzas Armadas y de Seguridad Argentinas"; // Name shown in the select menu.
        ...
        description = "Fuerzas Armadas y de Seguridad Argentinas - Multicam - Sólo armas y vehículos incluidos en mods FAA, FSA y CLV"; // If this isn't included, no description will show (unless inherited from the base class.)
        priority = 999;
    };
    class Fuerzas_Armadas_Argentinas_Selva : Vanilla_Base
    {
        ...
        description = "Fuerzas Armadas y de Seguridad Argentinas - Selva - Sólo armas y vehículos incluidos en mods FAA, FSA y CLV"; // If this isn't included, no description will show (unless inherited from the base class.)
        priority = 998;
    };
    class Fuerzas_Armadas_Argentinas_Arido : Vanilla_Base
    {
        ...
        description = "Fuerzas Armadas y de Seguridad Argentinas - Árido - Sólo armas y vehículos incluidos en mods FAA, FSA y CLV"; // If this isn't included, no description will show (unless inherited from the base class.)
        priority = 997;
    };
    ...
    class Fuerzas_Armadas_Argentinas_ext : Vanilla_Base
    {
        ...
        side = "Occ"; // Inv, Occ, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\occ\arg.paa); // Path to an icon to be displayed in the select menu.
        name = "Fuerzas Armadas y de Seguridad Argentinas (extendido)"; // Name shown in the select menu.
        file = "occ\Argentina ext"; // The template file name - .sqf, that gets appended automatically.
        maps[] = {}; // If this template should be prioritized on any maps (case sensitive to worldName)
        climate[] = {"temperate"}; // climate that the template can be selected on.
        description = "Fuerzas Armadas y de Seguridad Argentinas - Multicam - Con algunas armas y vehículos reales incluídas en Arma 3 vainilla, para mayor diversidad"; // If this isn't included, no description will show (unless inherited from the base class.)
        priority = 997;
    };
    class Fuerzas_Armadas_Argentinas_ext_Selva : Vanilla_Base
    {
        ...
        maps[] = {}; // If this template should be prioritized on any maps (case sensitive to worldName)
        climate[] = {"tropical"}; // climate that the template can be selected on.
        description = "Fuerzas Armadas y de Seguridad Argentinas - Selva - Con algunas armas y vehículos reales incluídas en Arma 3 vainilla, para mayor diversidad"; // If this isn't included, no description will show (unless inherited from the base class.)
        priority = 997;
    };
    class Fuerzas_Armadas_Argentinas_ext_Arido : Vanilla_Base
    {
        ...
        maps[] = {}; // If this template should be prioritized on any maps (case sensitive to worldName)
        climate[] = {"arid"}; // climate that the template can be selected on.
        description = "Fuerzas Armadas y de Seguridad Argentinas - Árido - Con algunas armas y vehículos reales incluídas en Arma 3 vainilla, para mayor diversidad"; // If this isn't included, no description will show (unless inherited from the base class.)
        priority = 997;
    };
...
///INV
    class Fuerzas_Armadas_Argentinas_inv : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
    ...
    class Fuerzas_Armadas_Argentinas_inv_Selva : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
        side = "Inv"; // Inv, Inv, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\Inv\arg.paa); // Path to an icon to be displayed in the select menu.
    ...
    class Fuerzas_Armadas_Argentinas_inv_Arido : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
        side = "Inv"; // Inv, Inv, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\Inv\arg.paa); // Path to an icon to be displayed in the select menu.
    ...
    class Fuerzas_Armadas_Argentinas_inv_Nieve : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
        side = "Inv"; // Inv, Inv, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\Inv\arg.paa); // Path to an icon to be displayed in the select menu.
    ...
    class Fuerzas_Armadas_Argentinas_inv_ext : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
        side = "Inv"; // Inv, Inv, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\Inv\arg.paa); // Path to an icon to be displayed in the select menu.
    ...
    class Fuerzas_Armadas_Argentinas_inv_ext_Selva : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
        side = "Inv"; // Inv, Inv, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\Inv\arg.paa); // Path to an icon to be displayed in the select menu.
    ...
    class Fuerzas_Armadas_Argentinas_inv_ext_Arido : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
        side = "Inv"; // Inv, Inv, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\Inv\arg.paa); // Path to an icon to be displayed in the select menu.
    ...
    class Fuerzas_Armadas_Argentinas_inv_ext_Nieve : Vanilla_Base
    {
        basepath = QPATHTOFOLDER(Templates); //the path to the folder the template is located in, this translates to "\x\A3AE\addons\templates\Templates\Vanilla"
        side = "Inv"; // Inv, Inv, Reb, Riv, Civ
        flagTexture = QPATHTOFOLDER(Templates\Inv\arg.paa); // Path to an icon to be displayed in the select menu.
...
///REB
    class Fuerza_Insurgente_Argentina : Vanilla_Base
    {
        ...
        name = "Fuerza Insurgente Argentina"; // Name shown in the select menu.
