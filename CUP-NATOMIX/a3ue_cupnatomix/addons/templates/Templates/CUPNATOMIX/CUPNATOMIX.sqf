...
//This a faction that simply mixes all equipment of the NATO members included in CUP base
//Bundeswehr, US army, Czech army, and British Armed forces united on the desire to destroy you
//I can't make it work as separate units belonging to one force or other,
//so you'll find any kind of uniform-loadout-vehicles-etcetera mix when playing it

//By now it's going to be available for woodland/temperate scenarios
...
//STARTED BY COPYING THE ACR ASSETS
...
//lines where to find cup faction assets in A3AU.pbo:
//ACR 251976
//BAF 259020
//bw1 236522?
//bw2 237745?
...
["name", "CUPNATOMIX"] call _fnc_saveToTemplate;                         //this line determines the faction name -- Example: ["name", "NATO"] - ENTER ONLY ONE OPTION
["spawnMarkerName", "ACR/BAF/BW/USA support corridor"] call _fnc_saveToTemplate;             //this line determines the name tag for the "carrier" on the map -- Example: ["spawnMarkerName", "NATO support corridor"] - ENTER ONLY ONE OPTION
...
["vehiclesLightUnarmed", [
    //ACR
        "CUP_B_UAZ_Open_ACR", "CUP_B_UAZ_Unarmed_ACR", "CUP_B_LR_Transport_CZ_W"
    //BAF
...
["vehiclesLightArmed", [
    //ACR
        "CUP_B_HMMWV_AGS_GPK_ACR", "CUP_B_HMMWV_DSHKM_GPK_ACR", "CUP_B_HMMWV_M2_GPK_ACR", "CUP_B_LR_Special_Des_CZ_D", "CUP_B_UAZ_SPG9_ACR", "CUP_B_UAZ_METIS_ACR", "CUP_B_UAZ_MG_ACR", "CUP_B_UAZ_AGS30_ACR", "CUP_B_Dingo_CZ_Wdl", "CUP_B_Dingo_GL_CZ_Wdl"
    //BAF
    ,   "CUP_B_BAF_Coyote_GMG_W", "CUP_B_BAF_Coyote_L2A1_W", "CUP_B_Jackal2_L2A1_GB_W", "CUP_B_LR_Special_M2_GB_W", "CUP_B_LR_MG_GB_W", "CUP_B_Ridgback_GMG_GB_W", "CUP_B_Ridgback_HMG_GB_W", "CUP_B_Ridgback_LMG_GB_W", "CUP_B_Wolfhound_GMG_GB_W", "CUP_B_Wolfhound_HMG_GB_W", "CUP_B_Wolfhound_LMG_GB_W"
    ]] call _fnc_saveToTemplate;
["vehiclesTrucks", [
    //ACR
        "CUP_B_T810_Armed_CZ_WDL", "CUP_B_T810_Unarmed_CZ_WDL"]] call _fnc_saveToTemplate;
...
["vehiclesAirborne", ["CUP_B_BRDM2_HQ_CZ", "CUP_B_BRDM2_CZ", "CUP_B_BRDM2_CZ"]] call _fnc_saveToTemplate;
["vehiclesLightTanks",  ["CUP_B_BMP2_CZ"]] call _fnc_saveToTemplate;
...
["vehiclesMilitiaAPCs", ["CUP_B_BRDM2_HQ_CZ", "CUP_B_BRDM2_CZ"]] call _fnc_saveToTemplate;
...
////CHECK THIS IF UNCONSISTENT CAMOS
...
_loadoutData set ["traitorUniforms", ["CUP_U_B_CZ_WDL_NoKneepads"]];
_loadoutData set ["traitorVests", ["V_Rangemaster_belt"]];
_loadoutData set ["traitorHats", ["CUP_H_CZ_Hat01"]];

_loadoutData set ["officerUniforms", ["CUP_U_B_CZ_WDL_NoKneepads"]];
_loadoutData set ["officerVests", ["V_Rangemaster_belt"]];
_loadoutData set ["officerHats", ["CUP_H_CZ_Hat01"]];
...
_eliteLoadoutData set ["uniforms", ["CUP_U_B_CZ_WDL_NoKneepads", "CUP_U_B_CZ_WDL_Kneepads", "CUP_U_B_CZ_WDL_Kneepads_Gloves"]];
_eliteLoadoutData set ["vests", ["CUP_V_CZ_vest04"]];
_eliteLoadoutData set ["slVests", ["CUP_V_CZ_vest08"]];
_eliteLoadoutData set ["mgVests", ["CUP_V_CZ_vest11"]];
_eliteLoadoutData set ["glVests", ["CUP_V_CZ_vest06"]];
_eliteLoadoutData set ["backpacks", ["CUP_O_RUS_Patrol_bag_Green", "CUP_O_RUS_Patrol_bag_Summer"]];
_eliteLoadoutData set ["atBackpacks", ["B_FieldPack_khk"]];
_eliteLoadoutData set ["helmets", ["CUP_H_CZ_Helmet10", "CUP_H_CZ_Helmet09", "CUP_H_CZ_Helmet04", "CUP_H_CZ_Helmet03"]];
_eliteLoadoutData set ["slHat", ["CUP_H_CZ_Hat03"]];
...
////// NO NEED TO TOUCH ANYTHING UNDER HERE //////
