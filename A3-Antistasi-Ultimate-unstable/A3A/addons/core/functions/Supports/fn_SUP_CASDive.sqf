...
private _suppData = [_supportName, _side, "CASDIVE", _targPos, 3000, _targArray];       // should radius be larger?
A3A_activeSupports pushBack _suppData;
[_suppData, _resPool, _airport, _vehType, _delay, _reveal] spawn A3A_fnc_SUP_CASDiveRoutine;

[_reveal, _side, "CASDIVE", _targPos, _delay] spawn A3A_fnc_showInterceptedSetupCall;
