...
_loadoutData set ["traitorUniforms", ["U_mas_chi_O_wint"]];
_loadoutData set ["traitorVests", ["V_mas_chi_PlateCarrier_w"]];
_loadoutData set ["traitorHats", ["CUP_H_PMC_Beanie_Winter"]];

_loadoutData set ["officerUniforms", ["U_mas_chi_O_soldw"]];
_loadoutData set ["officerVests", ["V_mas_chi_PlateCarrier_w"]];
...
_sfLoadoutData set ["uniforms", ["U_mas_chi_O_wint", "U_mas_chi_O_wint2", "U_mas_chi_O_soldw"]];
_sfLoadoutData set ["vests", ["V_mas_chi_PlateCarrier_w"]];
_sfLoadoutData set ["mgVests", ["V_mas_chi_PlateCarrier_w"]];
_sfLoadoutData set ["medVests", ["V_mas_chi_PlateCarrier_w"]];
_sfLoadoutData set ["glVests", ["V_mas_chi_PlateCarrier_w"]];
_sfLoadoutData set ["backpacks", ["O_mas_chi_Kitbag_w"]];
_sfLoadoutData set ["slBackpacks", ["O_mas_chi_Kitbag_w"]];
_sfLoadoutData set ["atBackpacks", ["O_mas_chi_Kitbag_w"]];
_sfLoadoutData set ["helmets", ["H_mas_chi_HelmetOW", "H_mas_chi_HelmetOW_gog"]];
_sfLoadoutData set ["slHat", ["H_mas_chi_beret_OS"]];
_sfLoadoutData set ["sniHats", ["CUP_H_PMC_Beanie_Winter"]];
...
_eliteLoadoutData set ["uniforms", ["U_mas_chi_O_wint", "U_mas_chi_O_wint2"]];
_eliteLoadoutData set ["slUniforms", ["U_mas_chi_O_soldw"]];
_eliteLoadoutData set ["vests", ["V_mas_chi_TacVest_w"]];
_eliteLoadoutData set ["mgVests", ["V_mas_chi_PlateCarrier_w"]];
_eliteLoadoutData set ["medVests", ["V_mas_chi_TacVest_w"]];
_eliteLoadoutData set ["slVests", ["V_mas_chi_PlateCarrier_w"]];
_eliteLoadoutData set ["glVests", ["V_mas_chi_PlateCarrier_w"]];
_eliteLoadoutData set ["engVests", ["V_mas_chi_PlateCarrier_w"]];
_eliteLoadoutData set ["backpacks", ["O_mas_chi_Kitbag_w"]];
_eliteLoadoutData set ["slBackpacks", ["O_mas_chi_Kitbag_w"]];
_eliteLoadoutData set ["atBackpacks", ["O_mas_chi_Kitbag_w"]];
_eliteLoadoutData set ["helmets", ["H_mas_chi_HelmetOW", "H_mas_chi_HelmetOW_gog"]];
_eliteLoadoutData set ["sniHats", ["CUP_H_PMC_Beanie_Winter"]];
...
_militaryLoadoutData set ["uniforms", ["U_mas_chi_O_wint", "U_mas_chi_O_wint2"]];
_militaryLoadoutData set ["slUniforms", ["U_mas_chi_O_soldw"]];
_militaryLoadoutData set ["vests", ["V_mas_chi_TacVest_w"]];
_militaryLoadoutData set ["mgVests", ["V_mas_chi_PlateCarrier_w"]];
_militaryLoadoutData set ["medVests", ["V_mas_chi_TacVest_w"]];
_militaryLoadoutData set ["slVests", ["V_mas_chi_PlateCarrier_w"]];
_militaryLoadoutData set ["glVests", ["V_mas_chi_PlateCarrier_w"]];
_militaryLoadoutData set ["engVests", ["V_mas_chi_PlateCarrier_w"]];
_militaryLoadoutData set ["backpacks", ["O_mas_chi_Kitbag_w"]];
_militaryLoadoutData set ["slBackpacks", ["O_mas_chi_Kitbag_w"]];
_militaryLoadoutData set ["atBackpacks", ["O_mas_chi_Kitbag_w"]];
_militaryLoadoutData set ["helmets", ["H_mas_chi_HelmetOW", "H_mas_chi_HelmetOW_gog"]];
_militaryLoadoutData set ["sniHats", ["CUP_H_PMC_Beanie_Winter"]];
...
_militiaLoadoutData set ["uniforms", ["U_mas_chi_O_wint", "U_mas_chi_O_wint2"]];
_militiaLoadoutData set ["vests", ["V_mas_chi_TacVest_w"]];
_militiaLoadoutData set ["sniVests", ["V_mas_chi_TacVest_w"]];
_militiaLoadoutData set ["backpacks", ["O_mas_chi_Kitbag_w"]];
_militiaLoadoutData set ["slBackpacks", ["O_mas_chi_Kitbag_w"]];
_militiaLoadoutData set ["atBackpacks", ["O_mas_chi_Kitbag_w"]];
_militiaLoadoutData set ["helmets", ["H_mas_chi_woodhead_sov_O", "H_mas_chi_HelmetOW", "H_mas_chi_woodhead_sov_O", "H_mas_chi_HelmetOW_gog"]];
_militiaLoadoutData set ["sniHats", ["CUP_H_PMC_Beanie_Winter"]];
