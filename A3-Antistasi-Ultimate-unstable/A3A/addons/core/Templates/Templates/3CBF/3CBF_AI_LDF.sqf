...
_loadoutData set ["cloakUniforms", ["UK3CB_LDF_B_U_CombatUniform_Ghillie_WDL"]];
_loadoutData set ["cloakVests", ["UK3CB_LDF_B_V_Vest_KKZ10_GEO", "UK3CB_LDF_B_V_MK_Vest_KKZ10_GEO"]];
