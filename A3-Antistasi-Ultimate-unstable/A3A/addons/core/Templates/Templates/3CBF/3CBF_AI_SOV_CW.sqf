...
_loadoutData set ["cloakUniforms", ["UK3CB_CW_SOV_O_Early_U_Spetsnaz_Uniform_01_Ghillie_KLMK", "rhs_uniform_klmk_oversuit"]];
_loadoutData set ["cloakVests", ["rhs_lifchik_NCO", "rhs_lifchik_light", "rhs_lifchik"]];
