...
["vehiclesAirborne", ["CUP_B_FV432_Bulldog_GB_D", "CUP_B_FV432_Bulldog_GB_D", "CUP_B_Mastiff_HMG_GB_D", "CUP_B_Mastiff_LMG_GB_D", "CUP_B_Mastiff_GMG_GB_D"]] call _fnc_saveToTemplate;
...
["vehiclesLightTanks",  ["CUP_B_FV510_GB_D", "CUP_B_FV510_GB_D_SLAT", "CUP_B_MCV80_GB_D", "CUP_B_MCV80_GB_D_SLAT"]] call _fnc_saveToTemplate;
...
_loadoutData set ["traitorUniforms", ["CUP_U_B_BAF_DDPM_UBACSTSHIRT"]];
_loadoutData set ["traitorVests", ["CUP_V_B_BAF_DDPM_Osprey_Mk3_Empty"]];
_loadoutData set ["traitorHats", ["CUP_H_BAF_DDPM_Mk6_EMPTY"]];

_loadoutData set ["officerUniforms", ["CUP_U_B_BAF_DDPM_UBACSLONG_Gloves"]];
_loadoutData set ["officerVests", ["CUP_V_B_BAF_DDPM_Osprey_Mk3_Empty"]];
...
_loadoutData set ["slHat", ["CUP_H_BAF_PARA_PRROVER_BERET"]];
