...
["vehiclesAirborne", ["CUP_B_BRDM2_CDF", "CUP_B_BRDM2_ATGM_CDF"]] call _fnc_saveToTemplate;
...
_loadoutData set ["traitorUniforms", ["CUP_U_B_CDF_SNW_1"]];
_loadoutData set ["traitorVests", ["CUP_V_CDF_6B3_1_SNW"]];
_loadoutData set ["traitorHats", ["CUP_H_CDF_H_PASGT_SNW"]];

_loadoutData set ["officerUniforms", ["CUP_U_B_CDF_SNW_2"]];
_loadoutData set ["officerVests", ["CUP_V_CDF_OfficerBelt"]];
_loadoutData set ["officerHats", ["CUP_H_CDF_OfficerCap_SNW"]];
...
_eliteLoadoutData set ["glVests", ["CUP_V_CDF_6B3_4_SNW"]];
_eliteLoadoutData set ["backpacks", ["CUP_O_RUS_Patrol_bag_Winter"]];
_eliteLoadoutData set ["atBackpacks", ["CUP_B_RPGPack_Khaki"]];
_eliteLoadoutData set ["helmets", ["CUP_H_CDF_H_PASGT_SNW"]];
_eliteLoadoutData set ["slHat", ["CUP_H_CDF_OfficerCap_SNW"]];
