...
["vehiclesAirborne", ["CUP_I_M113A1_RACS", "CUP_I_M113A1_RACS_URB"]] call _fnc_saveToTemplate;
...
["vehiclesMilitiaAPCs", ["CUP_I_M113A1_RACS"]] call _fnc_saveToTemplate;
...
_loadoutData set ["traitorUniforms", ["CUP_U_I_RACS_Desert_1", "CUP_U_I_RACS_Desert_2"]];
_loadoutData set ["traitorVests", ["CUP_V_B_Ciras_Khaki2"]];
_loadoutData set ["traitorHats", ["H_Booniehat_tan"]];

_loadoutData set ["officerUniforms", ["CUP_U_I_RACS_Desert_1"]];
_loadoutData set ["officerVests", ["CUP_V_PMC_CIRAS_Khaki_TL"]];
