...
_eliteLoadoutData set ["uniforms", ["CUP_I_B_PMC_Unit_9", "CUP_I_B_PMC_Unit_40", "CUP_I_B_PMC_Unit_43"]];
_eliteLoadoutData set ["vests", ["CUP_V_CPC_Fastbelt_coy"]];
_eliteLoadoutData set ["slVests", ["CUP_V_CPC_tlbelt_coy"]];
_eliteLoadoutData set ["mgVests", ["CUP_V_CPC_weaponsbelt_coy"]];
_eliteLoadoutData set ["glVests", ["CUP_V_CPC_weapons_coy"]];
_eliteLoadoutData set ["backpacks", ["CUP_B_AssaultPack_Coyote"]];
_eliteLoadoutData set ["atBackpacks", ["CUP_B_USPack_Coyote"]];
_eliteLoadoutData set ["helmets", ["CUP_H_OpsCore_Tan_SF"]];
_eliteLoadoutData set ["slHat", ["CUP_H_PMC_Cap_PRR_Grey"]];
