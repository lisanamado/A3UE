class vehicles_rf : vehicles_base
{
    ...
    ITEM(I_Pickup_rcws_rf, 4620, "ARMEDCAR", VEHICLE_CONDITION_ARMEDCAR);
    ITEM(AU_I_G_Pickup_Minigun_RF, 4420, "ARMEDCAR", VEHICLE_CONDITION_ARMEDCAR);
    ITEM(I_G_Pickup_Rocket_rf, 3970, "ARMEDCAR", VEHICLE_CONDITION_ARMEDCAR);
    ...
    ITEM(C_Truck_01_FFT_rf, 1750, "UNARMEDCAR", VEHICLE_CONDITION_UNARMEDCAR);
};
