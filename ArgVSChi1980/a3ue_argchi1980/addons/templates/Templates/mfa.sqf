...
["name", "MFA" ] call _fnc_saveToTemplate;
["nameLeader", "Reginaldo Anchorena Braun"] call _fnc_saveToTemplate;
...
["mortarMagazineHE", "ARTY_LIB_Sh_60_HE"] call _fnc_saveToTemplate;

["handGrenadeAmmo", ["LIB_F1"]] call _fnc_saveToTemplate;
["mortarAmmo", ["LIB_8Rnd_60mmHE_M2"/*"Sh_82mm_AMOS"*/]] call _fnc_saveToTemplate;
...
_loadoutData set ["carbines", [_ARGengrasadora,_ARGFMK,_recortada]];
_loadoutData set ["grenadeLaunchers", [_m1GL,_m2GL,_springfieldGL]];
_loadoutData set ["machineGuns", [_browning50b,_ARGfal]];
...
_loadoutData set ["antiInfantryGrenades", ["LIB_F1","ACE_M14"]];
...
_loadoutData set ["fullmask", [	
	"G_Balaclava_combat", "G_Balaclava_blk"
	,"G_Bandanna_khk","G_Bandanna_oli"
]];
...
_loadoutData set ["vests", ["V_LIB_UK_P37_Holster_Blanco","V_LIB_UK_P37_Rifleman_Blanco"]];
