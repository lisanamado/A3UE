...
["vehiclesPolice", ["UNI_UK_Willys_MB_G"]] call _fnc_saveToTemplate;                // cars used by police forces
...
_loadoutData set ["sniHats", ["H_Simc_Boon_tigre_2","H_Simc_Boon_tigre_1"]];
...
_policeLoadoutData set ["helmets", ["H_Simc_hat_trop_1"]];

_policeLoadoutData set ["SMGs", [_ARGFMK,_ARGengrasadora,_mauser]];
...
_eliteLoadoutData set ["vests", ["V_Simc_flak","V_Simc_flak_open"]];
...
_sfLoadoutData set ["uniforms", ["U_B_FullGhillie_lsh"]];
_sfLoadoutData set ["vests", ["V_Simc_flak_M56","V_Simc_flak_M56_open","V_Simc_flak_M56_open_60_alt","V_Simc_flak_M56_open_45_bandoleer"]];
