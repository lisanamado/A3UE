...
["magazines", createHashMapFromArray ["I_E_Truck_02_MRL_F", ["12Rnd_230mm_rockets"]]] call _fnc_saveToTemplate; //element format: [Vehicle class, [Magazines]]
["uavsAttack", [
    "sab_yak23_i"//pylons to be set
...
_policeLoadoutData set ["SMGs", [_militaSMGS]];
_policeLoadoutData set ["sidearms", [_pistols]];
...
_militiaLoadoutData set ["sidearms", _pistols];

//FALTA MILITARY, LOS PILONES DE LOS AVIONES, LAS LOGÍSTICAS DE VEHÍCULOS Y QUIZÁS ATRIBUTOS DE VEHÍCULO
...
_eliteLoadoutData set ["uniforms", ["U_B_CTRG_Soldier_Arid_F","U_B_CTRG_Soldier_3_Arid_F"]];
...
_eliteLoadoutData set ["slRifles", _sfRifles,];
_eliteLoadoutData set ["rifles", _fwaRiflesElite];
_eliteLoadoutData set ["carbines", _fwaCarbinesElite];
_eliteLoadoutData set ["grenadeLaunchers", _fwaGLElite];
_eliteLoadoutData set ["SMGs", _fwaCarbinesMilitary];
_eliteLoadoutData set ["machineGuns", _fwaMGsElite];
_eliteLoadoutData set ["marksmanRifles", _fwaMMriflesElite];

_eliteLoadoutData set ["sniperRifles", _fwaSniperElite];
_eliteLoadoutData set ["sidearms", [["hgun_ACPC2_F", "", "acc_flashlight_pistol", "", ["9Rnd_45ACP_Mag"], [], ""]]];
...
["arifle_CTAR_ghex_F", "muzzle_snds_58_ghex_F", "ACE_acc_pointer_green", _RifOptics, ["30Rnd_580x42_Mag_F"], [], ""]
,["arifle_CTAR_ghex_F", "muzzle_snds_58_ghex_F", "ACE_acc_pointer_green", _SpecOptics, ["30Rnd_580x42_Mag_F"], [], ""]
,["arifle_AK12U_lush_F", "muzzle_snds_B", "ACE_acc_pointer_green", _RifOptics, ["30rnd_762x39_AK12_Lush_Mag_F"], [], ""]
,["arifle_AK12U_lush_F", "muzzle_snds_B", "ACE_acc_pointer_green", _SpecOptics, ["30rnd_762x39_AK12_Lush_Mag_F"], [], ""]
,["sp_fwa_fal_factory_50_64", "", "", "", ["sp_fwa_scope_eltro_b8v_ir_scope"], [], ""]

]];
_sfLoadoutData set ["rifles", _sfRifles];
_sfLoadoutData set ["carbines", [
["arifle_AK12U_lush_F", "muzzle_snds_B", "ACE_acc_pointer_green", _HoloOptics, ["30rnd_762x39_AK12_Lush_Mag_F"], [], ""]
]];
_sfLoadoutData set ["grenadeLaunchers", [
["arifle_AK12_GL_lush_F", "muzzle_snds_B", "ACE_acc_pointer_green", _HoloOptics, ["30rnd_762x39_AK12_Lush_Mag_F"], [_underbarrelGrenades], ""]]
];
